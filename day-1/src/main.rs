...
fn output_top3_calories(calories:&Vec<u32>) {
    ...
    println!("elf {} has the third most calories with: {}", top3_elfs[2], top3_calories[2]);
    println!("elf {} has the second most calories with: {}", top3_elfs[1], top3_calories[1]);
    println!("elf {} has the most calories with: {}", top3_elfs[0], top3_calories[0]);
    
    println!("totaling: {}", top3_calories[0] + top3_calories[1] + top3_calories[2]);
}